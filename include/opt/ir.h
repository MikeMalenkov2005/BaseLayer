...
#define IR_VALUE_STRING_BIT (~IR_VALUE_INDEX_MASK)
...
DS_VectorDefine(IR_Value);

typedef struct IR_Global
{
  U32 name;   /* NAME INDEX   */
  U32 value;  /* VALUE INDEX  */
} IR_Global;
...
#define IR_IsValueIndex(index)  (!((index) & IR_VALUE_STRING_BIT))
#define IR_IsStringIndex(index) (!IR_IsValueIndex((index)))
